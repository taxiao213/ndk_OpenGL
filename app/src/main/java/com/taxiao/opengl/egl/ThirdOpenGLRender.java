 ...
 */
public class ThirdOpenGLRender implements GLSurfaceView.Renderer {
    private String TAG = this.getClass().getSimpleName();
    // 坐标归一化 数据类型是x,y,r,g,b
    float[] tableVertices = {
    ...
    public ThirdOpenGLRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        vertex = ShaderUtils.readRawTxt(mContext, R.raw.simple_vertex_shader1);
        fragment = ShaderUtils.readRawTxt(mContext, R.raw.simple_fragment_shader1);
        ...
        if (program > 0) {
            ...
            glVertexAttribPointer(aPositionLoaction, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, vertexData);
