...
/**
 * 使用三角形扇绘制,增加颜色属性,加入正交投影
 * Created by hanqq on 2021/12/22
 * Email:yin13753884368@163.com
 * CSDN:http://blog.csdn.net/yin13753884368/article
 * Github:https://github.com/taxiao213
 */
public class FourthOpenGLRender implements GLSurfaceView.Renderer {
    private String TAG = this.getClass().getSimpleName();
    // 坐标归一化 数据类型是x,y,r,g,b
    float[] tableVertices = {

            // 三角形扇
            -0.5f, 0.8f, 1f, 0.7f, 0.7f,
            -0.5f, -0.8f, 1f, 0.7f, 0.7f,
            0.5f, -0.8f, 1f, 0.7f, 0.7f,
            -0.5f, 0.8f, 1f, 0.7f, 0.7f,
            0.5f, -0.8f, 1f, 0.7f, 0.7f,
    ...
    public FourthOpenGLRender(Context context) {
