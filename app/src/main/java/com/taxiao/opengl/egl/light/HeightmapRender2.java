...
import com.taxiao.opengl.egl.heightmap.Heightmap;
 ...
 */
public class HeightmapRender2 extends BaseRenderImp {
    ...
    private HeightmapShaderProgram2 heightmapProgram;
    ...
    // 指向天空盒中的月亮
    private float[] vectorToLight = new float[]{0.30f, 0.35f, -0.89f, 0f};
    ...
    public HeightmapRender2(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        heightmapProgram = new HeightmapShaderProgram2(context);
        heightmap = new Heightmap2(((BitmapDrawable) context.getResources().getDrawable(R.mipmap.heightmap)).getBitmap());
    ...
    private void updateMvpMatrix() {
        // 将 modelViewMatrix 设置为合并后的模型视图投影矩阵，并把it_modelViewMatrix 设置为反转矩阵的倒置
