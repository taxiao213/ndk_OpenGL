 ...
 */
public class TXMutiGLSurfaceImageView extends TXEglSurfaceView {
    private String TAG = TXMutiGLSurfaceImageView.this.getClass().getSimpleName();
    private TXMutiImageRender txEglRender;
    private OnRenderCreateListener onRenderCreateListener;

    public TXMutiGLSurfaceImageView(Context context) {
        this(context, null);
    }

    public TXMutiGLSurfaceImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TXMutiGLSurfaceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public TXMutiImageRender getTXEglRender() {
        return txEglRender;
    }
    ...
    protected void onSizeChanged(int width, int height, int oldw, int oldh) {
        ...
        txEglRender = new TXMutiImageRender(getContext(), width, height);
