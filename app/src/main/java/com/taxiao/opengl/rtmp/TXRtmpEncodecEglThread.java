 ...
 */
public class TXRtmpEncodecEglThread extends Thread {
    private static String TAG = TXRtmpEncodecEglThread.class.getName();
    ...
    public TXRtmpEncodecEglThread(WeakReference<TXRtmpBaseMediaCodecEncoder> weakReference) {
